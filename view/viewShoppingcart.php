<div class="d-sm-inline-flex d-flex w-100" id="wrapper">
    ...
    <div class="w-100">
        <div class="container-fluid w-100">
            <h1 class="mt-4 mb-3 ml-5">Panier</h1>
            ...
            <?php
                if (isset($orderitems))
                {
                    ...
                    foreach($orderitems as $orderitem)
                    {
                        ...
                        <div class="product-box col-5 d-flex flex-column flex-lg-row flex-md-row flex-sm-column align-items-center justify-content-between border rounded mb-4 mr-5 pt-3 pb-3">
                            ...
                            <div class="d-flex flex-column align-items-center align-items-md-start align-items-lg-start">
                                <h3><?= $name ?></h3>
                                <p>Prix unitaire : <?= number_format($quantity * $price, 2) ?>€</p>
